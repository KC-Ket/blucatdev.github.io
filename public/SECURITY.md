...
If you discover a security vulnerability in this website or its services, please report it responsibly to **security@blucatdev.com** (contact email to be updated).
...
**Security Contact:** security@blucatdev.com (email to be configured)
